...
lifestress.LSQest(data = data_ALT_PROBLEM_11, ls = "TempNonthermal", dist = "Exponential", pp = "Blom",
                  stressunit1 = "K", stressunit2 = "V")
lifestress.MLEest(data = data_ALT_PROBLEM_11, ls = "TempNonthermal", dist = "Exponential", pp = "Blom", confid = 0.95,
                  stressunit1 = "K", stressunit2 = "V")
probplot.exp(data = data_ALT_PROBLEM_11, pp = "Blom", xlabel1 = "Time to Failure (hours)", MLE_i = 1,
             stressunit1 = "K", stressunit2 = "V")
