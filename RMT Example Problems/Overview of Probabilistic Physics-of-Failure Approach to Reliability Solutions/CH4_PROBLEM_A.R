...
lifestress.LSQest(data = data_ALT_PROBLEM_8, ls = "InversePower2", dist = "Lognormal", pp = "Blom",
                  xlabel1 = "Time to Failure (hours)", Llab = "Characteristic Life (hours)", Slab = "Load, W (MPa)",
                  stressunit1 = "MPa")

lifestress.MLEest(data = data_ALT_PROBLEM_8, ls = "InversePower2", dist = "Lognormal", pp = "Blom", confid = 0.95,
                  xlabel1 = "Time to Failure (hours)", Llab = "Characteristic Life (hours)", Slab = "Load, W (MPa)",
                  stressunit1 = "MPa")
